package com.wonkbike.ch5_gamesuit
...
import com.wonkbike.ui.game.CallbackMsg
import com.wonkbike.ui.game.Controller
import com.wonkbike.ui.game.Player
...
class MainActivity : AppCompatActivity() , CallbackMsg {
    ...
    private fun loadData() {
        val url = "https://i.ibb.co/Ryy59ps/GameSuit.jpg"
            ...
            findViewById<ImageButton>(i).setOnClickListener {
                ...
                when {
                    index < 3 -> {
                        ...
                        Log.d(
                            "MainActivity" ,
                            "$name Select ${btn.tag.toString().capitalize()}"
                        )
                        Toast.makeText(
                            this ,
                            "$name Select ${btn.tag.toString().capitalize()}" ,
    ...
    private fun selectPlayer(controller: Controller) {
        mutableListOf(
            ...
            findViewById<ImageButton>(i).setOnClickListener {
                ...
                Log.d(
                    "MainActivity" ,
                    "$mode Player 2 Select ${btn.tag.toString().capitalize()}"
                )
                Toast.makeText(
                    this ,
                    "$mode Select ${btn.tag.toString().capitalize()}" ,
                    Toast.LENGTH_SHORT
                ).show()
                btn.background =
                    ContextCompat.getDrawable(this , R.drawable.bg_item)
